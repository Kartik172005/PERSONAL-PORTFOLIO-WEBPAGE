...
The portfolio is built as a **single-page application** with smooth scrolling navigation between different sections such as Home, About, Projects, Skills, and Contact. The main focus of this project is simplicity, responsiveness, and clean UI design using core frontend technologies without any external frameworks.
...
This portfolio website reflects my learning progress and highlights the projects I have worked on, including quiz applications, utility systems, and frontend layouts for larger platforms such as e-learning and e-commerce websites.
...
- **GitHub Pages / Netlify (Optional)** – For deploying the website
...
- `style.css` handles all styling, layout, responsiveness, and UI effects.
- The project is kept simple and beginner-friendly for easy understanding.
...
- **Digital Periodic Table**  
  An interactive periodic table layout using structured grid design.

- **JavaScript Quiz App**  
  A multiple-choice quiz application with score tracking and dynamic questions.

- **E-Learning Platform (Frontend UI)**  
  A frontend interface for courses and video-based learning sections.

- **Online Grocery Website**  
  A responsive website layout for browsing grocery products.
